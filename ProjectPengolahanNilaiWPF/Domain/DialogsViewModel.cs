...
namespace MaterialDesignDemo.Domain
{
    public class DialogsViewModel : INotifyPropertyChanged
    {
        ...
        public ICommand OpenPlusPegDialogCommand => new AnotherCommandImplementation(ExecuteOpenPluspeg);
        ...
        private void ExecuteOpenPluspeg(object o)
        {

            //show the dialog

            var pluspeg = new plus_pegawai();
            DialogHost.Show(pluspeg, "MainDialog");
